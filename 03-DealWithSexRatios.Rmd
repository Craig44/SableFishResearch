...
### Scenario 2 
The second scenario assumed sex ratio was 50:50 at recruitment and females were more selective than males to the fishery. This was done by setting \alpha = 1.2 in Equation \@ref(eq:femaleselectivity). A third EM (EM3) was introduced for Approach 1, which fixed the female \alpha = 1. This is often the default approach. This is a side interest on biases when assessments assume equal selection between males and females when in fact there is selectivity difference.
