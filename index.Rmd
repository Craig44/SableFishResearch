...
- Chapter \@ref(spatialmodelInputs) describes data (other than tagging data see Chapter \@ref(tagdata)) that was explored for use in the spatial stock assessment model.
