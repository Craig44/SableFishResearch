...
Issues
- If I use spatio-temporal index models \(\mathcal{M}_3\) and \(\mathcal{M}_4\) I cannot get a positive definite hessian matrix. I believe this is due to the large standard errors (Figure \@ref(fig:indexComparison)).
- Recruit devs in recent years are very large and make me question model convergence (TODO: profile these recruit devs)
- Tag predictions want a larger F and thus larger Biomass. Predictions often higher than observed values. Consider turning of initial tag-mortality, tag-shedding and increase tag-reporting.
