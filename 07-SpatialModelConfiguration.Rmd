...
- When did we choose to start the model and why
- What spatial regions did we start with and why
- How many fisheries
- What observations were included?
...
```{r initialspatialObservations, out.width = '100%', fig.height= 8, fig.cap="Observation type and frequency for the initial model.", echo = F, eval = T}
include_graphics(file.path("Figures", "Observation_Frequency.png"))
```


```{r initialspatialObservations, out.width = '100%', fig.height= 7, fig.cap="Catch (kilo tonnes) by gear and area.", echo = F, eval = T}
