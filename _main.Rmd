...
### Estimating initial effective sample sizes {-}
...
We can crudely look at the proportion of recoveries across recovery regions that were released in a given region shown in Figure \@ref(fig:EmpiricalRecoveries). Care must be taken when interpreting these numbers because recovery rates among regions will differ which this plot is ignoring.
...
include_graphics(file.path("Figures", "empirical_tag_recoveries.png"))
```
