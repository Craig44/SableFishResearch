...
plot(ages, MLE_mixed_all_rep$mean_length_at_age, type = "l", lwd = 3, col = "blue", xlab = "Age", ylab = "Length (cm)", ylim = c(0, 240))
lines(ages, mean_length_at_age, col = "gold", lty = 3, lwd = 3)
