...
include_graphics(file.path("Figures", "empirical_tag_recoveries_with_releases.png"))
```
...
include_graphics(file.path("Figures", "empirical_tag_recoveries_by_length_group.png"))
```
