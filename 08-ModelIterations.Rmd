...
```{r movement3AreaModel, out.width = '60%', fig.height= 4, fig.cap="Estimated movement in the three area model", echo = F, eval = T}
include_graphics(file.path("Figures", "Application" ,"3-Area","TagData_01","Est_movement.png"))
```



```{r ssb3AreaModel, out.width = '60%', fig.height= 4, fig.cap="Estimated SSB in the three area model", echo = F, eval = T}
...
```{r movement5AreaModel, out.width = '60%', fig.height= 4, fig.cap="Estimated movement in the three area model", echo = F, eval = T}
include_graphics(file.path("Figures", "Application" ,"5-Area","Model_01","Est_movement.png"))
```



```{r ssb5AreaModel, out.width = '60%', fig.height= 4, fig.cap="Estimated SSB in the three area model", echo = F, eval = T}
